...
namespace MedistockAppCore.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdUser,DocumentType,NameU,Lastname,Birthdate,Age,Gender,PhoneNumber,Profession,Address,Email,Password,FkIdRole")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUser,DocumentType,NameU,Lastname,Birthdate,Age,Gender,PhoneNumber,Profession,Address,Email,Password,FkIdRole")] User user)
        {
            if (id != user.IdUser)
            {
                return NotFound();
